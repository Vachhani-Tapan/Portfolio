...
export function CardStack<T extends CardStackItem>({
  ...
  cardWidth = 520,
  cardHeight = 350, // Slightly taller
  ...
  return (
    <div
      className={cn("w-full overflow-hidden", className)} // Added overflow-hidden to prevent horizontal scroll bars
    ...
    >
      ...
      <div
        ...
        onKeyDown={onKeyDown}
      >
        {/* background wash / spotlight (unique feel) - Adjusting colors for portfolio bg */}
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-white/5 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full bg-white/5 blur-3xl dark:bg-black/30"
          aria-hidden="true"
        />
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border-2 border-white/10 dark:border-white/10 overflow-hidden shadow-2xl bg-[#111]", // Using #111 to match certificates
                  ...
                  style={{
                    width: cardWidth,
                    maxWidth: '90vw', // added responsive sizing logic
                    height: cardHeight,
                    zIndex,
...
function DefaultFanCard({ item }: { item: CardStackItem; active: boolean }) {
  return (
    <div className="relative h-full w-full bg-black">
      ...
      {/* content */}
      <div className="relative z-10 flex h-full flex-col justify-end p-6 border-t border-white/5 mt-auto">
        <div className="truncate text-xl font-bold text-white tracking-wide">
          {item.title}
        </div>
        {item.description ? (
