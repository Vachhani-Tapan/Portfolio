                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                },
                                {
                                    ...
                                    hoverShadow: 'group-hover:shadow-[0_0_15px_rgba(34,211,238,0.15)]'
                                },
                                {
                                    label: 'GitHub',
                                ...
                                },
                                {
                                    ...
                                    url: 'https://www.linkedin.com/in/tapan-vachhani-691433394/',
                                ...
                                return (
                                    <Wrapper
                                        key={idx}
                                        href={item.url}
                                        target={item.url ? (item.label === 'Email' ? '_self' : '_blank') : undefined}
